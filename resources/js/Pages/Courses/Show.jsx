...
export default function Show({ course, enrollment, accessLevel }) {
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="mt-1 text-sm text-green-700">
                                    {accessLevel.message || 'You have full access to this course.'}
                                </p>
                            </div>
                            <a
                ...
                return (
                    <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-6">
                        <div className="flex items-center">
                            ...
                            <div>
                                <h3 className="text-lg font-semibold text-yellow-800">Awaiting Approval</h3>
                                <p className="mt-1 text-sm text-yellow-700">
                                    {accessLevel.message || 'Your access request is being reviewed. You will be notified once approved.'}
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="mt-1 text-sm text-red-700">
                                    {accessLevel.message || 'Your request to access this course has been denied.'}
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="mt-1 text-sm text-blue-700">
                                    {accessLevel.message || 'This course requires approval. Submit a request to get access.'}
                                </p>
                            </div>
                            <button
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="mt-1 text-sm text-indigo-700">
                                    {accessLevel.message || 'Enroll in this course to start learning.'}
                                </p>
                            </div>
                            <button
