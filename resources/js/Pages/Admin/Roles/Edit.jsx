            ...
            <div className="space-y-6">
                ...
                <div>
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                        Update the details and permissions for the <span className="font-medium">{role.display_name || role.name}</span> role.
                    </p>
                </div>
                        ...
                        <div className="px-4 py-5 sm:p-6 space-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value={role.name}
                                    disabled
                                    className="mt-1 block w-full rounded-md border-gray-300 bg-gray-50 text-gray-500 shadow-sm sm:text-sm cursor-not-allowed"
                                />
                                <p className="mt-1 text-xs text-gray-400">Role name cannot be changed.</p>
                            </div>
