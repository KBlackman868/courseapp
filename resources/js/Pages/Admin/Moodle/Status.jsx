...
export default function Status({ stats = {} }) {
    ...
    const handleImportCourses = () => {
        router.visit('/admin/moodle/courses/import');
    };
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                            ...
                            <div className="rounded-lg border border-gray-200 p-4">
                                ...
                                <button
                                    ...
                                    className="w-full inline-flex items-center justify-center rounded-md bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 transition-colors"
                                >
                                    Import Courses
                                </button>
                            </div>
