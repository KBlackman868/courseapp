            ...
            <div className="flex min-h-screen">
                    ...
                    <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20">
                        ...
                        <div className="animate-fade-in-up-delay-1">
                            <h1 className="text-4xl xl:text-5xl font-bold text-white leading-tight mb-6">
                                Welcome back to<br />
                                <span className="text-indigo-200">your learning journey</span>
                            </h1>
                        </div>

                        <div className="animate-fade-in-up-delay-2">
                            <p className="text-lg text-indigo-100/80 max-w-md leading-relaxed mb-10">
                                Access your courses, track your progress, and continue building your professional skills with the Ministry of Health.
                            </p>
                        </div>
                ...
                <div className="w-full lg:w-1/2 xl:w-[45%] flex flex-col">
                    ...
                    <div className="lg:hidden bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-8 text-center">
                        ...
                        <p className="text-indigo-100 text-sm">Sign in to continue your learning journey</p>
                    </div>
                    ...
                    <div className="flex-1 flex items-center justify-center px-6 sm:px-12 lg:px-16 py-12">
                        <div className="w-full max-w-md">
                            ...
                            <form onSubmit={submit} className="space-y-5">
                                ...
                                <div className="animate-fade-in-up-delay-2 flex items-center justify-between">
