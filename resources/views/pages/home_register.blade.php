    ...
    <div class="glass rounded-3xl shadow-2xl p-8 pulse-glow">
      ...
      <div class="relative my-6">
        ...
        <div class="relative flex justify-center text-sm">
          <span class="px-4 bg-white text-gray-500 rounded-full">Or sign up with</span>
        </div>
      </div>
      ...
      <div>
        <a href="{{ route('auth.google') }}" 
          class="w-full flex justify-center items-center px-4 py-3 border border-gray-300 rounded-xl bg-white hover:bg-gray-50 transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-[1.01]">
          <!-- Google Icon -->
